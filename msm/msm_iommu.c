...
static void msm_iommu_tlb_add_flush(unsigned long iova, size_t size, size_t granule,
...
static const struct iommu_gather_ops null_tlb_ops = {
    .tlb_flush_all = msm_iommu_tlb_flush_all,
    .tlb_add_flush = msm_iommu_tlb_add_flush,
...
#else
    pagetable->ttbr = ttbr0_cfg.arm_lpae_s1_cfg.ttbr[0];
#endif
	/*
